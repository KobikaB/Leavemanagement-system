...
<body>
    ...
    <div class="login-container" id="loginContainer">
       <img class="corner-image" src="uvLogo.png" alt="Corner Image">
        <div class="login-btn-container">
            <!-- <button class="login-btn student-btn"><a href="login.php" style="color: white;">Login as a Student</a></button> -->
            <button class="login-btn staff-btn" ><a href="login.php" style="color: white;">Login as a Staff</a></button>
            <button class="login-btn admin-btn"><a href="login.php" style="color: white;">Login as Administrator</a></button>
        </div>
