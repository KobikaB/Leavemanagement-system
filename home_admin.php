...
<body>
    <div id="header">
        ...
        <div class="button-container">
            <a href="login.php" class="button" id="backBtn">Back</a>
            <div id="logout">
    ...
    <div id="container1">
        ...
        <div class="list-container">
            <div class="list-item">
                <span>Staff 1</span>
                <a href="staff1.php" class="view-button button">View</a>
            </div>
            <div class="list-item">
                <span>Staff 2</span>
                <a href="staff2.php" class="view-button button">View</a>
            </div>
            <div class="list-item">
                <span>Staff 3</span>
                <a href="staff3.php" class="view-button button">View</a>
            </div>
            <div class="list-item">
                <span>Staff 4</span>
                <a href="staff4.php" class="view-button button">View</a>
            </div>
        </div>
    </div>
